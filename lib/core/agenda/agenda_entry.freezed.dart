...
mixin _$AgendaEntry {
 ...
 String get id; String get sourceModule; String get sourceId; IconData get icon; String get title; DateTime get time; Color get dotColor; bool get isUrgent; bool get isAllDay;
...
@override
int get hashCode => Object.hash(runtimeType,id,sourceModule,sourceId,icon,title,time,dotColor,isUrgent,isAllDay);

@override
String toString() {
  return 'AgendaEntry(id: $id, sourceModule: $sourceModule, sourceId: $sourceId, icon: $icon, title: $title, time: $time, dotColor: $dotColor, isUrgent: $isUrgent, isAllDay: $isAllDay)';
}
...
@useResult
$Res call({
 String id, String sourceModule, String sourceId, IconData icon, String title, DateTime time, Color dotColor, bool isUrgent, bool isAllDay
});
...
/// Create a copy of AgendaEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? sourceModule = null,Object? sourceId = null,Object? icon = null,Object? title = null,Object? time = null,Object? dotColor = null,Object? isUrgent = null,Object? isAllDay = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String sourceModule,  String sourceId,  IconData icon,  String title,  DateTime time,  Color dotColor,  bool isUrgent,  bool isAllDay)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AgendaEntry() when $default != null:
return $default(_that.id,_that.sourceModule,_that.sourceId,_that.icon,_that.title,_that.time,_that.dotColor,_that.isUrgent,_that.isAllDay);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String sourceModule,  String sourceId,  IconData icon,  String title,  DateTime time,  Color dotColor,  bool isUrgent,  bool isAllDay)  $default,) {final _that = this;
switch (_that) {
case _AgendaEntry():
return $default(_that.id,_that.sourceModule,_that.sourceId,_that.icon,_that.title,_that.time,_that.dotColor,_that.isUrgent,_that.isAllDay);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String sourceModule,  String sourceId,  IconData icon,  String title,  DateTime time,  Color dotColor,  bool isUrgent,  bool isAllDay)?  $default,) {final _that = this;
switch (_that) {
case _AgendaEntry() when $default != null:
return $default(_that.id,_that.sourceModule,_that.sourceId,_that.icon,_that.title,_that.time,_that.dotColor,_that.isUrgent,_that.isAllDay);case _:
  return null;
...
class _AgendaEntry implements AgendaEntry {
  const _AgendaEntry({required this.id, required this.sourceModule, required this.sourceId, required this.icon, required this.title, required this.time, required this.dotColor, required this.isUrgent, this.isAllDay = false});
...
/// Create a copy of AgendaEntry
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? sourceModule = null,Object? sourceId = null,Object? icon = null,Object? title = null,Object? time = null,Object? dotColor = null,Object? isUrgent = null,Object? isAllDay = null,}) {
